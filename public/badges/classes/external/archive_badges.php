...
/**
 * Class archive_badges
 *
 * @package    core_badges
 * @copyright  2025 Southampton Solent University {@link https://www.solent.ac.uk}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class archive_badges extends external_api {
    /**
    ...
    /**
     * Archive the given badges.
     *
     * @param array $badgeids List of badge identifiers to archive.
     * @return array
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
                'result' => new external_value(PARAM_BOOL, 'True if all badges were archived successfully'),
