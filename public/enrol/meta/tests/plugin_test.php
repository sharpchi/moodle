...
final class plugin_test extends \advanced_testcase {
    ...
    /**
     * Display name for Meta course is linked to the meta course depending on permissions
     *
    ...
    public function test_get_instance_name_for_management_page(): void {
        ...
        $student1 = $this->getDataGenerator()->create_and_enrol($course1, 'student');
        $student2 = $this->getDataGenerator()->create_and_enrol($course1, 'student');
        ...
        $this->getDataGenerator()->enrol_user($student2->id, $course2->id, 'student');
