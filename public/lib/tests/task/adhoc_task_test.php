...
final class adhoc_task_test extends \advanced_testcase {
    ...
    /**
     * Test getting name of task that uses default implementation of get_name with component
     *
     * @runInSeparateProcess
     * @covers \core\task\adhoc_task
     * @return void
     */
    public function test_get_name_component_default(): void {
        $this->resetAfterTest();
        ...
        $this->assertEquals('Adhoc fake task (Fake full featured plugin)', $task->get_name());
    }
